...
#ifndef DONT_INCLUDE_IMAGELIBS
#ifdef WIN32
#if _MSC_VER >=1300
 #ifdef _MT
  #ifdef _DLL
   #pragma message("Note: including lib: pngMTDLL.lib") 
   #pragma comment(lib, "pngMTDLL.lib")
  #else
   #pragma message("Note: including lib: pngMT.lib") 
   #pragma comment(lib, "pngMT.lib")
  #endif //_DLL
 #else
  #pragma message("Note: including lib: png.lib") 
  #pragma comment(lib, "png.lib")
 #endif
#else
 #ifdef _MT
  #ifdef _DLL
   #pragma message("Note: including lib: pngMTDLL6.lib") 
   #pragma comment(lib, "pngMTDLL6.lib")
  #else
   #pragma message("Note: including lib: pngMT6.lib") 
   #pragma comment(lib, "pngMT6.lib")
  #endif //_DLL
 #else
  #pragma message("Note: including lib: png6.lib") 
  #pragma comment(lib, "png6.lib")
 #endif
#endif
#endif
#endif
